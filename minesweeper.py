...
class Minesweeper:
    ...
    def __init__(self, tk):
        ...
        self.images = {'plain': PhotoImage(file = 'images/tile.png'), 'clicked': PhotoImage(file = 'images/clicked_tile.png'), 'mine': PhotoImage(file = 'images/mine.png'), 'flag': PhotoImage(file = 'images/flag.png'), 'wrong': PhotoImage(file = 'images/wrong_flaged.png'), 'numbers': []}
